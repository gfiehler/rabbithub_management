...
HELP['unsubscribe_on_http_post_error'] = '<p><strong>RabbitHub environment variable-</strong> <mark><strong>unsubscribe_on_http_post_error</strong></mark>:  (true, false) <dl><dt>true: (default)</dt><dd>on HTTP Post error to subscriber, the consumer will be unsubscribed</dd> <dt>false:</dt> <dd>on HTTP Post error to subscriber the consumer will not be unsubscribed</dd><dt>Note: </dt><dd>If this variable is set to false, it will override unsubscribe_on_http_post_error_limit and unsubscribe_on_http_post_error_timeout_microseconds and not unsubscribe even when reaching the configured limits.</dd></dl></p>';
...
HELP['unsubscribe_on_http_post_error_timeout_microseconds'] = '<p><strong>RabbitHub environment variable-</strong> <mark><strong>unsubscribe_on_http_post_error_timeout_microseconds</strong></mark>:  (microseconds) <dl><dt>Time interval where unsubscribe_on_http_post_error_limit errors are allowed to happen prior to unsubscribing the consumer</dt><dt>Note:</dt><dd>unsubscribe_on_http_post_error_limit and unsubscribe_on_http_post_error_timeout_microseconds must be set as a pair as it designates that unsubscribe_on_http_post_error_limit may occur within unsubscribe_on_http_post_error_timeout_microseconds time interval before the consumer is unsubscribed</dd></dl></p>';
...
HELP['http_client_options'] = '<p><strong>RabbitHub environment variable-</strong> <mark><strong>http_client_options</strong></mark>:  (various) <dl><dt>These are options that can be set to control the http client behaviour.</dt></dl></p>';
